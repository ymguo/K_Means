...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep  7 22:07:47 2019
...
def main():
    ...
    colmap = {0: 'r', 1: 'g', 2: 'b'}
    df = assignment(df, centroids, colmap) ## 我们的数据集
...
#        key = cv2.waitKey()
        ...
        plt.close()  ## 每次迭代 都把前一次画的图删除

        ## 比较新算出的centroid 是否和 前面算出的 converge
